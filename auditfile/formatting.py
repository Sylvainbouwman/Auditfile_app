...
LABELS: dict[str, str] = {
    ...
    "bron": "Bron",
    "sb_index": "Subadministratie",
    "sbType": "Soort subadministratie",
    "sbDesc": "Omschrijving subadministratie",
    "sb_nr": "Regelnummer",
    "koppeling": "Gekoppeld via",
    "obLineNr": "Regel beginbalans",
    "jrnID": "Dagboek",
    "trNr": "Transactie",
    "trLineNr": "Regel",
    "custSupID": "Relatie",
    "invRef": "Factuurreferentie",
    "invTp": "Factuursoort",
    "invPurSalTp": "Inkoop of verkoop",
    "invDt": "Factuurdatum",
    ...
    "totaal_debet_volgens_bestand": "Totaal debet volgens bestand",
    "totaal_credit_volgens_bestand": "Totaal credit volgens bestand",
    "regels_gelezen": "Regels gelezen",
    "totaal_debet_gelezen": "Totaal debet gelezen",
    "totaal_credit_gelezen": "Totaal credit gelezen",
    "bevinding": "Bevinding",
    ...
    "eindsaldo": "Eindsaldo",
    "grootboek_beginsaldo": "Grootboek begin",
    "grootboek_eindsaldo": "Grootboek eind",
    "openstaand_begin": "Openstaand begin",
    "openstaand_eind": "Openstaand eind",
    "mutatie_boekjaar": "Mutatie boekjaar",
    "verloop_verschil": "Verloopverschil",
    "verschil_begin": "Verschil begin",
    "verschil_eind": "Verschil eind",
    "eindsaldo_vorig": "Eindsaldo vorig jaar",
    "beginsaldo_huidig": "Beginsaldo huidig jaar",
    "ernst": "Ernst",
    ...
    "grondslag_volgens_aangifte": "Grondslag volgens aangifte",
    "verschil_grondslag": "Verschil grondslag",
    "rubriek_voorstel": "Voorgestelde rubriek",
    "signaal": "Signaal",
    "aantal_signalen": "Signalen",
    "pagina": "Te vinden op",
    "boven_drempel": "Boven de drempel",
    "sleutel": "Sleutel",
    "soort": "Soort",
    "status": "Status",
...
STATUSKLEUREN: dict[str, str] = {
    ...
    "verschil in grondslag": "rgba(255, 193, 7, 0.18)",
    "niet ingedeeld": "rgba(120, 120, 120, 0.12)",
    "beginsaldo wijkt af van de eindstand": "rgba(220, 53, 69, 0.18)",
    "eindsaldo vorig jaar niet overgenomen": "rgba(220, 53, 69, 0.18)",
    "beginsaldo zonder eindsaldo vorig jaar": "rgba(255, 193, 7, 0.18)",
    "resultaatbestemming eigen vermogen": "rgba(25, 135, 84, 0.12)",
